...
**Hujjat holati:** F0 prototipi natijalari bilan yangilangan
**Sana:** 2026-09-04
**O'lchov manbai:** [`docs/F0-NATIJALAR.md`](docs/F0-NATIJALAR.md)
...
**F1 ga kirishdan oldin bajarilishi shart:**
...
| ID | Mavzu | Holat |
|---|---|---|
| ADR-001 | Inference runtime: ONNX Runtime Mobile vs LiteRT | ✅ Yozildi — `docs/ADR-001-inference-runtime.md` |
...
| ADR-007 | Probe oynasini qisqartirish (qisman ochish) | **Ochiq — F1** |
...
*Hujjat oxiri. v2.3 uchun: real qurilmada o'lchov natijalaridan keyin 3 (C-02, C-03),
6 (barcha ishlash raqamlari) va 14-bo'limlar yangilanadi; ADR-007 yopiladi.*
